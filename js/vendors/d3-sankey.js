...
function ascendingSourceBreadth(a, b) {
  return ascendingSourceBreadthSorter(a.source, b.source);
}

function ascendingTargetBreadth(a, b) {
  return ascendingTargetBreadthSorter(a.target, b.target);
}

function ascendingBreadth(a, b) {
  // console.debug(a, b);
  // return a.sourceLinks.length - b.sourceLinks.length;
  // return a.y0 - b.y0;
  return b.value - a.value;
}

function ascendingSourceBreadthSorter(a, b) {
  return b.value - a.value;
}

function ascendingTargetBreadthSorter(a, b) {
  return b.value - a.value;
}
...
var sankey = function() {
  ...
  function computeLinkBreadths(graph) {
    graph.nodes.forEach(function(node) {
      node.sourceLinks.sort(ascendingSourceBreadth);
      node.targetLinks.sort(ascendingTargetBreadth);
    });
    graph.nodes.forEach(function(node) {
